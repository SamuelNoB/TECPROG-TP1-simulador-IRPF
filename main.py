...
for i in range(value):
    desc = input("Digite a descrição do seu rendimento (valores positivos) ou dedução (valores negativos): ")
    valor = float(input("Digite o valor desse rendimento (valores positivos) ou dedução (valores negativos): "))
...
aliquota_efetiva = Aliquota_efetiva(calculado['total']['valor_imposto'], calculado['total']['valor_base'])
