...
for i in range(value):
    desc = input(
        "Digite a descrição do seu rendimento (valores positivos) ou dedução (valores negativos): "  # noqa E501
    )
    valor = float(
        input(
            "Digite o valor desse rendimento (valores positivos) ou dedução (valores negativos): "  # noqa E501
        )
    )
