...
faixa_um_valor = [(1500, 1500, 0)]

faixa_dois_valores = [(1000, 1000, 0), (1903.98, 1903.98, 0)]

faixa_tres_valores = [(0, 0, 0), (50, 50, 0), (1900, 1900, 0)]
...
@pytest.mark.parametrize(
    "faixas", [faixa_um_valor, faixa_dois_valores, faixa_tres_valores]
)
    ...
    for dados in casos:
        ...
        for faixa in dados[1]:
            print(
                faixa,
                "->",
                dados[1][faixa]["valor_base"],
                dados[1][faixa]["valor_imposto"],
                imposto_calculado[faixa]["valor_imposto"],
            )
            assert (
                dados[1][faixa]["valor_base"]
                == imposto_calculado[faixa]["valor_base"]
            )
            assert (
                dados[1][faixa]["valor_imposto"]
                == imposto_calculado[faixa]["valor_imposto"]
